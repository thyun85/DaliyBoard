...
public class PostReviewEtcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_review_etc);

//        getSupportActionBar().setSubtitle("Etc");
    ...
    public void clickUpload(View v){
        String serverUrl = "http://thyun85.dothome.co.kr/dailyboard/insertETReviewCDB.php";
...
//                new AlertDialog.Builder(PostActivity.this).setMessage(response).setPositiveButton("OK", null).create().show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PostReviewEtcActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
