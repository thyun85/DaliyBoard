...
public class PostReviewSk8Activity extends AppCompatActivity {
...
//        getSupportActionBar().setSubtitle("sk8");
    ...
    public void clickUpload(View v){
        String serverUrl = "http://thyun85.dothome.co.kr/dailyboard/insertSK8ReviewDB.php";
...
//                new AlertDialog.Builder(PostActivity.this).setMessage(response).setPositiveButton("OK", null).create().show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PostReviewSk8Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
